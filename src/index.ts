...
export interface PluginOptions extends KatexOptions {
    showInlineWithDisplayStyle?: boolean;
}
...
function math_block(state: any, start: number, end: number, silent: any){
...
export default function math_plugin(md: MarkdownIt, options: PluginOptions) {
    // Default options
    ...
    var katexInline = function(latex: string){
        options.displayMode = options.showInlineWithDisplayStyle ? true : false;
        try{
